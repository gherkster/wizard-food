...
import CustomInputRichTextHtml from "./custom-input-rich-text-html.vue";

export default defineInterface({
  id: "custom-recipe-ingredient",
  name: "Recipe Ingredient",
  description: "Recipe ingredient editor component",
  icon: "format_quote",
  component: CustomInputRichTextHtml,
  types: ["text"],
  group: "other",
  preview: PreviewSVG,
  options: {
